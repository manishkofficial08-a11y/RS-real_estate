...
async def send_email_message(
    ...
    if not _smtp_configured():
        logger.warning("EMAIL NOT SENT because SMTP is not configured. Subject=%s Recipients=%s", subject, clean_recipients)
    ...
    try:
        ...
        logger.exception("Failed to send email. Subject=%s Recipients=%s", subject, clean_recipients)
