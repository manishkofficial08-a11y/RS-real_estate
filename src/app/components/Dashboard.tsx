...
function SmartBuildingScene({
  ...
  const glass = darkMode ? "rgba(15,23,42,0.72)" : "rgba(255,255,255,0.72)";
  const border = darkMode ? "rgba(129,140,248,0.22)" : "rgba(99,102,241,0.16)";

  return (
    <div className="relative min-h-[240px] overflow-hidden rounded-[2rem] border p-4" style={{ background: glass, borderColor: border }}>
      <div
        className="absolute inset-0"
        style={{
          background: darkMode
            ? "radial-gradient(circle at 20% 20%, rgba(99,102,241,0.22), transparent 30%), radial-gradient(circle at 88% 18%, rgba(6,182,212,0.18), transparent 28%), linear-gradient(135deg, rgba(15,23,42,0.45), rgba(30,41,59,0.28))"
            : "radial-gradient(circle at 20% 20%, rgba(99,102,241,0.14), transparent 30%), radial-gradient(circle at 88% 18%, rgba(6,182,212,0.12), transparent 28%), linear-gradient(135deg, rgba(248,250,252,0.94), rgba(238,242,255,0.78))",
        }}
      />

      <div className="relative z-10 grid grid-cols-[1fr_0.9fr] gap-4">
        <div>
          <div className="mb-4 inline-flex items-center gap-2 rounded-full px-3 py-1 text-[11px] font-medium" style={{ color: accent, background: `${accent}14`, border: `1px solid ${accent}22` }}>
            <Brain size={13} />
          ...
          <div className="mt-5 grid grid-cols-3 gap-2">
            {[
              ...
              <div key={item.label} className="rounded-2xl border p-3" style={{ background: darkMode ? "rgba(15,23,42,0.48)" : "rgba(255,255,255,0.74)", borderColor: border }}>
                <p className="text-[10px] uppercase tracking-wide" style={{ color: darkMode ? "#64748b" : "#94a3b8" }}>{item.label}</p>
                <p className="mt-1 text-sm font-semibold" style={{ color: accent }}>{item.value}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="relative h-[210px]">
          <div
            ...
            style={{
              background: darkMode ? "linear-gradient(180deg, rgba(30,41,59,0.92), rgba(15,23,42,0.86))" : "linear-gradient(180deg, rgba(255,255,255,0.96), rgba(224,231,255,0.88))",
              borderColor: border,
              boxShadow: darkMode ? "0 24px 70px rgba(0,0,0,0.45)" : "0 24px 70px rgba(99,102,241,0.20)",
            }}
          >
            <div className="absolute left-1/2 top-4 h-[154px] w-[34px] -translate-x-1/2 rounded-full" style={{ background: darkMode ? "rgba(99,102,241,0.12)" : "rgba(99,102,241,0.10)" }} />
            <motion.div
              ...
              style={{ background: "linear-gradient(135deg, #6366f1, #06b6d4)", color: "#fff", boxShadow: "0 0 24px rgba(99,102,241,0.55)" }}
            >
              AI
            </motion.div>
            ...
            <div className="absolute right-3 top-4 space-y-4">
              {floorLabels.map((floor, index) => (
                <div key={floor} className="flex items-center gap-2">
                  ...
                  <span className="text-[9px]" style={{ color: darkMode ? "#94a3b8" : "#64748b" }}>{floor}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          >
            <div className="flex h-full flex-col items-center justify-center">
              ...
              <p className="text-[10px] font-semibold" style={{ color: accent }}>BOT</p>
              <p className="text-[8px]" style={{ color: darkMode ? "#64748b" : "#94a3b8" }}>assistant</p>
            </div>
          </motion.div>

          <div className="absolute bottom-2 right-1 h-10 w-24 rounded-2xl border" style={{ background: darkMode ? "rgba(16,185,129,0.10)" : "rgba(16,185,129,0.12)", borderColor: "rgba(16,185,129,0.20)" }}>
        ...
        <motion.div
          ...
          style={{
            ...
            boxShadow: darkMode
              ...
              : "0 26px 80px rgba(99,102,241,0.16)",
          }}
        >
          <div
