      ...
      <div className="max-w-5xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: darkMode ? "#4a5568" : "#94a3b8" }}>284 files · 4.2 GB used of 10 GB</p>
          </div>
        ...
        >
          ...
          <p className="text-xs mt-1" style={{ color: darkMode ? "#4a5568" : "#94a3b8" }}>PNG, JPG, MP4, MOV up to 500MB · AI auto-analysis on upload</p>
        </div>
...
function Team({ darkMode }: { darkMode: boolean }) {
  const members = [
    { name: "Jane Doe", role: "Owner", email: "jane@company.com", avatar: "JD", color: "#6366f1", status: "online" },
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: darkMode ? "#4a5568" : "#94a3b8" }}>5 members · 2 seats remaining</p>
          </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: darkMode ? "#4a5568" : "#94a3b8" }}>3 connected · 60+ available</p>
          </div>
        ...
        <div className="rounded-2xl border p-5 relative overflow-hidden" style={{ background: "linear-gradient(135deg, rgba(99,102,241,0.12) 0%, rgba(139,92,246,0.08) 100%)", borderColor: "rgba(99,102,241,0.2)" }}>
          ...
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs mt-1" style={{ color: darkMode ? "#4a5568" : "#94a3b8" }}>Next billing: July 1, 2026 · Auto-renew enabled</p>
            </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm mt-0.5" style={{ color: darkMode ? "#4a5568" : "#94a3b8" }}>4 active automations · 591 total runs</p>
          </div>
          <button className="flex items-center gap-2 px-4 py-2 rounded-xl text-sm font-medium" style={{ background: "linear-gradient(135deg, #6366f1, #8b5cf6)", color: "#ffffff" }}>
          ...
          {automations.map((auto, i) => (
            <div key={i} className="flex items-center gap-4 p-4 rounded-2xl border transition-all hover:border-primary/20" style={cardBase(darkMode)}>
              ...
              <div className="text-right">
                ...
                <span className="text-xs" style={{ color: auto.status === "active" ? "#10b981" : "#f59e0b" }}>● {auto.status}</span>
              </div>
            </div>
          ))}
        </div>
